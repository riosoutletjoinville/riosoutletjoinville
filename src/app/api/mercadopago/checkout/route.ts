  ...
  try {
    ...
    try {
      ...
      // Campos específicos para pessoa JURÍDICA (obrigatórios)
        ...
        dadosCliente.razao_social = cliente_dados?.razao_social || cliente_nome;
        dadosCliente.cnpj = cliente_dados?.cnpj || "";
        dadosCliente.nome_fantasia =
          cliente_dados?.nome_fantasia || cliente_nome;
        dadosCliente.inscricao_estadual =
          cliente_dados?.inscricao_estadual || ""; // NOVO
    ...
    const pedidoData = {
      ...
      // Campos de frete (agora extraídos do body)
      frete_valor: frete_valor || 0,
      frete_gratis: frete_valor === 0,
      opcao_frete: frete_nome || null,
      prazo_entrega: frete_prazo || null,
      cep_entrega: cliente_dados?.cep || null,
    ...
    // Adicionar frete como item na preferência se houver
