//src/app/dashboard/mercado-livre/config/MercadoLivreConfig.tsx
'use client';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        setTimeout(() => {
          router.push('/dashboard/mercado-livre');
        }, 2000);
      } else {
        setSaveStatus('error');
      }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="https://dominio.com.br"
                required
              />
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="https://dominio.com.br/api/mercadolibre/callback"
                required
              />
              <p className="text-sm text-gray-500 mt-1">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <button
                type="button"
                onClick={() => router.push('/dashboard/mercado-livre')}
