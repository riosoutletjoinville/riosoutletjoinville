...
export default async function ProdutoPage({ params }: Props) {
  ...
  function ScrollToVariacoes() {
    ...
    return null; // Só pra registrar a função
  }
            ...
            <div className="flex items-center text-sm text-gray-600">
              ...
              {produtoTyped.categoria?.categoria_pai && (
                <>
                  ...
                  >
                    <span className="mx-2"> / </span>
                    {produtoTyped.categoria.categoria_pai.nome}
                  </Link>
                </>
              )}
              <Link
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Informações */}
              <div>
                <div id="selecao-variante" className="scroll-mt-4">
                ...
                {produtoTyped.descricao && (
                  <ExpandableText
                    text={produtoTyped.descricao}
                    maxLength={200}
                    className="mb-6"
                    scrollToId="selecao-variante"
                  />
                )}
          ...
          {relacionados && relacionados.length > 0 && (
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {(relacionados as unknown as ProdutoRelacionado[]).map(
                  (rel) => {
                    const imagem =
                      rel.imagens?.find((img) => img.principal) ||
                      rel.imagens?.[0];
