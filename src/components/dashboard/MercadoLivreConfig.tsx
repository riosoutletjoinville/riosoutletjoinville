      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="https://punk-alias-specialist-counting.trycloudflare.comapi/mercadolibre/callback"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded"
            placeholder="https://punk-alias-specialist-counting.trycloudflare.com"
          />
        </div>
